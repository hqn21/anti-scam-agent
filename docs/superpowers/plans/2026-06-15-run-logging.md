...
def test_cost_known_model_with_cache_discount():
    ...
    # 1000 prompt tokens of which 200 cached, 500 completion.
    c = cost_usd("gpt-4.1", input_tokens=1000, cached_input_tokens=200, output_tokens=500)
...
def test_metrics_from_counts_sets_cost_and_totals():
    ...
    assert m.total_tokens == 1300       # input + cached + output
